...
import 'package:cloud_firestore/cloud_firestore.dart';
import '../SmartWidgets/button.dart';
          ...
          child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 30),
                  TextInputGrayBox(emailController, 'Email', TextInputType.emailAddress),
                  TextInputGrayBox(passwordController, 'Password', TextInputType.visiblePassword),
                  TextButton(
                    onPressed: () async {
                      setState(() {
                      ...
                      await Users().verifyUser(email, password).then((QuerySnapshot docs) {
